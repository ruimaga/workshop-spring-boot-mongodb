...
import com.ruimagalhaes.workshopmongo.services.UserService;
...
public class UserResource {
	...
	public ResponseEntity<List<UserDTO>> findAll() {
		...
		return (ResponseEntity<List<UserDTO>>) ResponseEntity.ok().body(listDto);
	}
	...
	public ResponseEntity<Void> insert(@RequestBody UserDTO objDto) {
		 ...
		 User obj =  (User) service.fromDTO(objDto);
